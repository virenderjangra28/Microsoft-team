...
export const DisplayNameField = (props) => {
    ...
    const [isInvalidLength, setIsInvalidLength] = useState(!hasValidLength(defaultName !== null && defaultName !== void 0 ? defaultName : ''));
    ...
    return (React.createElement(TextField, { autoComplete: "off", defaultValue: defaultName, inputClassName: inputBoxTextStyle, label: TEXTFIELD_LABEL, required: true, className: inputBoxStyle, onChange: onNameTextChange, id: TEXTFIELD_ID, placeholder: TEXTFIELD_PLACEHOLDER, styles: TextFieldStyleProps, errorMessage: isEmpty ? TEXTFIELD_EMPTY_ERROR_MSG : isInvalidLength ? TEXTFIELD_EXCEEDS_MAX_CHARS : undefined }));
};
